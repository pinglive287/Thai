...
<style>
body {
    background-image: url("<?= $themes ?>assets/images/thai/page1/bg.png");
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-2">
            <img src="<?= $themes ?>assets/images/thai/page1/test-logo.png" alt="" class="no-save img-fluid logo">
        </div>
        <div class="col-lg">
            <div class="text-center">
                ...
                <img src="<?= $themes ?>assets/images/thai/page1/banner.png" alt="" class="no-save img-fluid banner">
                <img src="<?= $themes ?>assets/images/thai/page1/btn-send.png" alt="" class="send-img">
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-lg">
            ...
            <img src="<?= $themes ?>assets/images/thai/page1/btn-cerrect.png" alt="" class="cerrect-img">
        </div>
        <div class="col-lg">
            ...
            <img src="<?= $themes ?>assets/images/thai/page1/btn-wrong.png" alt="" class="wrong-img">
        </div>
    </div>
</div>
