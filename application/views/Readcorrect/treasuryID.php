...
<style>
body {
    background-image: url("<?= $themes ?>assets/images/thai/page3/bg-treasury.png");
...
<div class="container-fluid">
        ...
        <div class="col mt-3">
            <div class="text-end" style="color: #8a603a;">
                <a href="<?= site_url('Readcorrectly_controller') ?>"><img
                        src="<?= $themes ?>assets/images/thai/page3/home.png" width="60vh"
                        class="img-hover-effect me-3"></a>
                <a href="#" onclick="window.close();"><img src="<?= $themes ?>assets/images/thai/page3/exit.png"
    ...
    ?>
    <a href="<?= $link ?>"><img src="<?= $themes ?>assets/images/thai/page3/btn-start.png" width="60vh" class="start"></a>
</div>